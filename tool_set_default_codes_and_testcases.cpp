...
int input_problem_count() {
    ...
    while (true) {
        ...
        cout << "How many problems you want to create?" << endl;
...
bool create_testcases(const string& problem_name, int testcase_count) {
    ...
    for (int testcase_index = 1; testcase_index <= testcase_count; ++testcase_index) {

        create_testcase_x_in(problem_name, testcase_index);
